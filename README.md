...
Проект направлен на облегчение работы для администраторов, а именно помощь в мониторинге и защиты системы. Для выполнения этой задачи проект предоставляет набор утилит, затрагивающих основные аспекты защиты системы.
